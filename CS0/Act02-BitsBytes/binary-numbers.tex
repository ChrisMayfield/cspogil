...
Binary & Decimal \\
\hline
\includegraphics[height=1in]{binary1.png} & \\
\bin{1}{0}{1}{0} & \ans{10} \\
\hline
\includegraphics[height=1in]{binary2.png} & \\
\bin{1}{0}{1}{1} & \ans{11} \\
\hline
\includegraphics[height=1in]{binary3.png} & \\
\bin{1}{1}{0}{0} & \ans{12} \\
\hline
\includegraphics[height=1in]{binary4.png} & \\
\bin{1}{1}{1}{1} & \ans{15} \\
\hline
\end{tabular}
\end{center}
