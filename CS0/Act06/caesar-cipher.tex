...
\ans[30em]{THE BEST THINGS IN LIFE ARE FREE}

\item What is the key (the shift)?

\ans[30em]{The key is 22: A shifts to W, three letters to the left.}
...
\ans[30em]{There are 26 keys; however, the key of zero is worthless.}
...
\item one advantage: \ans[20em]{It's very simple and fast to compute.}

\item one disadvantage: \ans[20em]{It's very easy to guess the key.}
