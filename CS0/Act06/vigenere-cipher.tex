...
\ans[465pt]{It's still relatively simple to compute, and more secure than Caesar ciphers.}

\item one disadvantage:

\ans[465pt]{The key is more complex, and it may be slower to perform the encryption.}
