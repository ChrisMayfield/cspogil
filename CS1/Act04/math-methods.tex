...
Consider the following methods \emph{defined} in the \java{Math} class:
...
To \emph{invoke} methods from another class (like \java{Math}), you must first specify the class name:
...
\Q When {\it defining} a method (like \java{random} or \java{abs}), what do you need to specify before the method name and after the method name?
