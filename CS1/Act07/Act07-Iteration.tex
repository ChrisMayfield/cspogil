...
On Question 22, students may forget to use a {\tt long} variable to store the factorial. If time permits, show the output of the solution when {\tt fact} is declared as {\tt int}.
}
