...
\begin{enumerate}
\item What is the index for the element \java{'i'}? \ans[10em]{1}
\item What is the length of \java{letterArray}? \ans[10em]{2}
\item What is the length of \java{numberArray}? \ans[10em]{365}
\item How would you access the last element of \java{numberArray}?
\ans[10em]{\java{numberArray[364]}}
\end{enumerate}
...
\vspace{1ex}
\ans[35em]{\tt new int[] \{0, 14, 1024, 127, 3, 5521\}}
...
\vspace{1ex}
\ans[35em]{\tt new double[] \{3.23, 1.52, 4.23, 32.5, 2.45, 5.23, 3.33\}}
