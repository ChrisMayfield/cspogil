...
\Q \label{encap}
Based on the diagram, what does it mean for a class to encapsulate data?
...
\Q What is the \emph{value} of a \java{char} variable?
What is the \emph{value} of an array variable?
What is the \emph{value} of a \java{String} variable?
