...
\Q Describe how you would implement the \java{equals} and \java{toString} methods of the \java{CreditCard} class (i.e., what they would do and which attributes they would use).
