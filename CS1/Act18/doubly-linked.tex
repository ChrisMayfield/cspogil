...
Java's implementation of \java{LinkedList} stores two references in each node: one for the \textit{previous}, and one for the \textit{next}.
...
\Q How many operations are required to add an element \textit{at the start} of this list?
...
\Q How many operations are required to add an element \textit{at the end} of this list?
...
\Q What problems of singly-linked lists do doubly-linked lists solve? (In other words, what do the \java{previous} and \java{tail} make possible?)
