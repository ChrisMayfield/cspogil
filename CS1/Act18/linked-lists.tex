...
\Q How many assignment operations are required to add 14 \textit{at the front} of an empty list? Note that creating a \java{Node} takes two assignments (one for \java{value} and one for \java{next}).
