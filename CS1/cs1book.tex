...
\mod{5} Arrays and Loops ~ (optional)
}
...
\mod{1} POGIL Research \\
\mod{2} Common Methods \\
\mod{3} Credit Card
}
...
\act{Act18/Act18-LinkedStructures}{Linked Structures}{
\mod{1} List Interface \\
\mod{2} Array Lists \\
\mod{3} Linked Lists \\
\mod{4} Doubly-Linked Lists
}
