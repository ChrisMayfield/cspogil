...
\Q How many lines of source code invoke the \java{println} method? \ans{Three (lines 4, 6, 10)}
\vspace{1em}


\Q How many times is \java{println} invoked when the program runs? \ans{Five times}
\vspace{1em}
