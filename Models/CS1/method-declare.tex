...
Consider the following methods from the \java{Math} class:
...
Here is the documentation for the examples listed above:
...
\Q How many parameters and arguments does each method typically have?
